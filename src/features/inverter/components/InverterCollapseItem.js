...
const InverterCollapseItem = props => {
    ...
    return (
        <div className="py-2">
            <div className="py-2 px-4" style={{ border: selected ? '1.6px solid #0B3D92' : null, borderRadius: 2, background: style === undefined ? 'white' : style.background }}>
                <div className="py-2 d-flex justify-content-between border-0 align-items-center">
                    ...
                    <div className="d-flex ">
                        <div className=" px-2 mx-3 text-center d-flex align-items-center rounded"
                            style={{ background: style === undefined ? '#e5eefa' : style.background, fontSize: 12 }}>
                            {codeno}
                        </div>
                        <div data-toggle="collapse"
                            style={{ cursor: 'pointer', fontSize: 18, color: '#e5e5e5 ' }}
