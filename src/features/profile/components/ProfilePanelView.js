...
const ProfilePanelView = props => {
    ...
    return (
        <div>
            <div  style={{ color: '#FF8902', fontSize: fsc(media, 14) }}>Panels</div>
            <div className="flex-fill py-2">
                <div className="d-flex">
                    <div style={{ fontSize: fsc(media, 25), color: '#0B3D92' }} className="font-weight-bold ">
                        {"188"}
                    </div>
                    <div style={{ fontSize: fsc(media, 15) }} className=" pt-2"> &nbsp;Panels</div>
                </div>
                <div style={{ fontSize: fsc(media, 12), color: '#C4C4C4' }}>NO.OF PANELS</div>
            </div>

            <div style={{ color: '#FF8902', fontSize: fsc(media, 14) }} className=" pt-3">PANELS SPEC/BRAND MODEL</div>
