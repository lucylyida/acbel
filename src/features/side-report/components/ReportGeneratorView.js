...
const ReportGeneratorView = props => {
    ...
    return (
        <div>
            <div className="pt-3" style={{ color: '#FF8902', fontSize: fsc(media, 14) }}>REPORT GENERATION</div>
            <div className="d-flex flex-lg-nowrap flex-wrap pt-3">
                <div className=" flex-fill ">
                    <div style={{ fontSize: fsc(media, 13), color: '#999999' }}>GENERATE FORM</div>
                    <div><KmButton text="SELECT" /></div>
                </div>

                <div className="py-1 px-3  flex-fill">
