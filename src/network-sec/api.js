...
// export const FETCH_GLOBAL_HOME_STATUS_DATA_WITH_ID = vendorId => `${BASE_URL}/global/${vendorId}`

export const FETCH_SITE_PROFILE_DATA = `${BASE_URL}/vendors/1/sites/2091/profiles`
