            ...
            <div className="">
                <div className="py-2" style={{}}>
                    <DataTable
                        ...
                        paginationComponent={() => <CustomPagination media={media} />}
                    />
                </div>
            </div>
        </div>
...
const CustomPagination = props => {
    ...
    return (
        <div className={`w-100 d-flex align-items-center ${media.mobile ? 'justify-content-start' : 'justify-content-center'}`}>
            <div onClick={() => alert("1")} className="px-1">
                <span className="p-2"
            ...
            <div onClick={() => alert("2")} className="px-1">
                <span className="p-2"
            ...
            <div onClick={() => alert("3")} className="px-1">
                <span className="p-2"
                    style={{ fontSize: 11, color: 'black', backgroundColor: "white", borderRadius: 4 }}
                >
                    {"3"}
            ...
            <div>{"..."}</div>
            <div onClick={() => alert("10")} className="px-1">
                <span className="p-2"
                    style={{ fontSize: 11, color: 'black', backgroundColor: "white", borderRadius: 4 }}
                >
                    {"10"}
